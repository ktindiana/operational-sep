...
"""This and supporting codes are found in the respository:
    ...
    below. The SEP dates will be read in from a csv file with the columns:
        ...
        Experiment - GOES-08 up to GOES-15, EPHIN, SEPEM, SEPEMv3
        Flux Type - differential or integral
        Flags - Options are blank, TwoPeak, DetectPreviousEvent, or SubtractBG
        Model Name - blank if not a model
        User Filename - name of file containing SEP time profile that user wants
        to input
        ...
        E.g. the format for observations is:
        StartDate, Enddate, Experiment, FluxType, Flags,,,options,bgstartdate,
            bgenddate
    
        E.g. th format for 'user', indicating a user-input flux file, is:
    ...
    Output files include:
        ...
        An aggregated list of information for all of the SEP events for
            each of the thresholds containing:
            Start Time,End Time,Onset Peak Flux,Onset Peak Time,Max Flux,
                Max Flux Time,Fluence
